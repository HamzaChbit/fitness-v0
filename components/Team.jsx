    ...
    <div className='mx-auto max-w-7xl h-full' >
        <div className='flex flex-col items-center justify-center mt-8' >
            <div className='flex flex-col justify-center items-center' >
                ...
                <p className='w-[80%]  text-md py-8 ' >I'm a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. I’m a great place for you to tell a story and let your users know a little more about you.</p>
            </div>
            {/* team backround */}
            <div className='flex flex-wrap min-w-full gap-1 ' >
                <div className='bg-team-one    bg-cover  h-[70vh] min-w-[30%]  xxl:min-w-[30%]  xl:min-w-[30%]  lg:min-w-[40%]   md:min-w-[52%]  mdl:min-w-[72%] sm:min-w-[82%]  xs:min-w-[92%] ml-5
                   opacity-250 bg-no-repeat flex justify-end  flex-col ' >
