  ...
  return (
    <div  className='bg-body  h-auto mx-auto' >
      ...
      <div className='text-white flex flex-col justify-center items-center mt-10   ' >
        ...
        <p  className='w-[65%] text-md mt-10  lg:w-[40%]   hidden  xxl:block xl:block lg:block  md:block mdl:block sm:hidden  xs:hidden  ' > I'm a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. I’m a great place for you to tell a story and let your users know a little more about you.</p>
        </div>
      {/* images coursrs */}
      <div  className=' flex justify-center mb-12 mt-12 items-center gap-7 flex-col min-w-7xl  h-auto  box-border  mx-auto' >
       ...
       <p  className='text-md font-light px-10' > I'm a paragraph. Click here to add your own text and edit me. It’s easy</p>
       <Link href='/' >
