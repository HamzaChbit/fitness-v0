...
<div  className='mt-5   mx-auto h-auto  max-w-7xl flex  flex-wrap    gap-5 '>
  <div className='flex  flex-col justify-center items-center px-5 ' >
    <div>
       <Image  width={350 } height={400} src='/image/2e2a49_0beae01326244da9936b9bdec997e578_mv2_d_2598_2205_s_2.webp' />
    </div>
  ...
  <div className='flex flex-col justify-center items-center  px-5 ' >
    <Image  width={350 } height={400} src='/image/2e2a49_3a098004e4d6421985ef27877c26bb38_mv2_d_2598_2205_s_2.webp' />
  ...
  <div className='flex flex-col justify-center items-center px-5 ' >
    <Image  width={350 } height={400} src='/image/7.webp' />
  ...
  <div className='flex  flex-col justify-center items-center px-5 ' >
    <Image  width={350 } height={400} src='/image/8.webp' />
  ...
  <div className='flex flex-col justify-center items-center px-5  ' >
    ...
    <Image  width={350 } height={400} src='/image/2e2a49_dd367b07e33c4bf1b9777f2fe08cd512_mv2_d_2598_2205_s_2.webp' />
  ...
  <div className='flex flex-col justify-center items-center  px-5' >
       ...
       <Image  width={350 } height={450} src='/image/9.webp'  />
